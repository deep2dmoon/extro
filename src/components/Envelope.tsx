            ...
            >
                ...
                >
                    ...
                    <motion.div
                        ...
                        animate={isOpen ? { y: -180, opacity: 1, scale: 1.02 } : { y: 0, opacity: 0, scale: 0.95 }}
                        className="absolute inset-x-4 sm:inset-x-8 top-6 bg-[#1a1a1a] p-8 sm:p-12 rounded-sm shadow-[0_50px_100px_rgba(0,0,0,0.5)] z-0 border border-white/5 flex flex-col items-center justify-center min-h-[250px] sm:min-h-[300px] backdrop-blur-xl"
                    >
                        <motion.div
